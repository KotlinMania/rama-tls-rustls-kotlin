...
kotlin {
    ...
    val xcf = XCFramework("RamaTlsRustls")

    macosArm64 {
        binaries.framework { baseName = "RamaTlsRustls"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaTlsRustls"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaTlsRustls"
        flattenPackage = "io.github.kotlinmania.ramatlsrustls"
    }

    android {
        namespace = "io.github.kotlinmania.ramatlsrustls"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-tls-rustls-kotlin", version.toString())

    pom {
        name.set("rama-tls-rustls-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - tls implementations for rama using rustls")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-tls-rustls-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-tls-rustls-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-tls-rustls-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-tls-rustls-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaTlsRustlsXCFramework",
    "assembleRamaTlsRustlsDebugXCFramework",
    "assembleRamaTlsRustlsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseIosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugMacosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseMacosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugTvosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseTvosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugWatchosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaTlsRustlsXCFramework",

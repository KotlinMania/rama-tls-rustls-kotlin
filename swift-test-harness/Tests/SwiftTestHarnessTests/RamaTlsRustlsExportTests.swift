...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RamaTlsRustls.swiftmodule/`
...
//      `import RamaTlsRustls` above would fail at compile time.
//
//   2. The static archive `libRamaTlsRustls.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RamaTlsRustls" }` and
//      `flattenPackage = "io.github.kotlinmania.ramatlsrustls"` configuration in
...
//      via the `RamaTlsRustlsLibrary` product.
//
...
final class RamaTlsRustlsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "RamaTlsRustls swift module imported cleanly")
    }
}

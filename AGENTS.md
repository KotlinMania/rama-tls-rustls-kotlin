...
This file is the quick-reference operating contract for rama-tls-rustls-kotlin. The longer
...
rama-tls-rustls-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-tls-rustls`](https://crates.io/crates/rama-tls-rustls). Upstream Rust is the behavioral oracle while the
